...
This repository contains the first assignment for the Urban Computing course in fall 2025. The excersises can be found in _"Lab1_Exercises.ipynb"_. Note that this is merely a warm-up exercise and that it **will not be graded nor does it have to be submitted.**
